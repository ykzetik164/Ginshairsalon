  ...
  return (
    <>
      ...
      <main id="top">
        ...
        <section className="colorNotesSection" data-reveal>
          <div className="colorNotesCopy">
            <p className="lead">完整的色彩鑑定，從肌膚色調到全身造型，一次整理清楚。</p>
            <p>
              鑑定會先觀察膚色冷暖與明度、瞳孔與髮色，並依春夏秋冬四季系統找出你的形象基礎，接著用149種診斷色布逐一比對，直接看出最顯氣色、也該避開的顏色系。
            </p>
            <p>
